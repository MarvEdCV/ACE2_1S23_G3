        ...
        axios.get('http://localhost:4010/api/humedad', {responseType: 'json'}).then(function(res) {
            ...
            if(res.status==200) {
                ...
                for (i = 0; i < res.data.length; i++) {
                    ...
                    points[i] = new GPoint(readableDateTime, res.data[i].humedad_relativa);
                ...
                plot.setTitleText("Grafica de Humedad Relativa");
                plot.getXAxis().setAxisLabelText("Fecha y hora");
                plot.getYAxis().setAxisLabelText("Humedad Relativa (%)");
